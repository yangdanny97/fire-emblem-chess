...
/* harmony import */ var _Sounds_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
...
class Game {
    constructor() {
        this.board = _Board_bs_js__WEBPACK_IMPORTED_MODULE_1__.init();
    ...
    winSound() {
        _Sounds_js__WEBPACK_IMPORTED_MODULE_4__.victory.play();
    }

    cursorSound() {
        _Sounds_js__WEBPACK_IMPORTED_MODULE_4__.cursor.play();
    }

    successSound() {
        _Sounds_js__WEBPACK_IMPORTED_MODULE_4__.select.play();
    }

    failureSound() {
        _Sounds_js__WEBPACK_IMPORTED_MODULE_4__.warning.play();
    }

    moveSound() {
        _Sounds_js__WEBPACK_IMPORTED_MODULE_4__.move.play()
    }

    turnStartSound() {
        if (this.turn === Colors.white) {
            _Sounds_js__WEBPACK_IMPORTED_MODULE_4__.white_turn.play();
        } else {
            _Sounds_js__WEBPACK_IMPORTED_MODULE_4__.black_turn.play();
        }
    }

    captureSound() {
        _Sounds_js__WEBPACK_IMPORTED_MODULE_4__.capture.play();
    }
    ...
    handlePromote(key) {
        ...
        switch (key) {
            case 66: // B
                piece = _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.bishop(_Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getColor(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(this.selectedPiece));
                break;
            case 78: // N
                piece = _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.knight(_Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getColor(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(this.selectedPiece));
                break;
            case 82: // R
                piece = _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.rook(_Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getColor(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(this.selectedPiece));
                break;
            case 81: // Q
                piece = _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.queen(_Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getColor(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(this.selectedPiece));
                break;
        }
        if (piece === undefined) {
            this.failureSound();
