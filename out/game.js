...
var Utils = __webpack_require__(1);
var Pieces = __webpack_require__(12);
var Belt_List = __webpack_require__(5);
var Belt_Array = __webpack_require__(6);
var Caml_array = __webpack_require__(4);
...
function makeGrid(board, turnColor, param, selectedPiece, legalMoves) {
  var otherColor = Utils.oppositeColor(turnColor);
  var coveredPositions = Pieces.getCoveredPositionsForColor(board, otherColor);
  var emphasizedCoveredPositions = Pieces.getEmphasizedCoveredPositionsForColor(board, otherColor);
  var grid = Belt_Array.makeBy(8, (function (x) {
          return Belt_Array.makeBy(8, (function (y) {
                        return makeSquare(x, y, turnColor);
                      }));
        }));
  Belt_List.forEach(board.pieces, (function (p) {
  ...
  Caml_array.get(Caml_array.get(grid, param[0]), param[1]).selection = true;
  if (selectedPiece !== undefined) {
    Caml_array.get(Caml_array.get(grid, Utils.getX(selectedPiece)), Utils.getY(selectedPiece)).selection = true;
    if (legalMoves !== undefined) {
      Belt_Array.forEach(legalMoves, (function (param) {
...
/* harmony import */ var _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
...
class Game {
    constructor() {
        this.board = _Board_bs_js__WEBPACK_IMPORTED_MODULE_1__.board([
            // white pawns
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.white, 0, 1),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.white, 1, 1),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.white, 2, 1),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.white, 3, 1),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.white, 4, 1),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.white, 5, 1),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.white, 6, 1),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.white, 7, 1),
            // white pieces
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.rook(Colors.white, 0, 0),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.rook(Colors.white, 7, 0),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.knight(Colors.white, 1, 0),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.knight(Colors.white, 6, 0),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.bishop(Colors.white, 2, 0),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.bishop(Colors.white, 5, 0),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.queen(Colors.white, 3, 0),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.king(Colors.white, 4, 0),
            // black pawns
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.black, 0, 6),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.black, 1, 6),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.black, 2, 6),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.black, 3, 6),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.black, 4, 6),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.black, 5, 6),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.black, 6, 6),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.pawn(Colors.black, 7, 6),
            // black pieces
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.rook(Colors.black, 0, 7),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.rook(Colors.black, 7, 7),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.knight(Colors.black, 1, 7),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.knight(Colors.black, 6, 7),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.bishop(Colors.black, 2, 7),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.bishop(Colors.black, 5, 7),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.queen(Colors.black, 3, 7),
            _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.king(Colors.black, 4, 7),
        ]);
    ...
    handlePromote(key) {
        ...
        switch (key) {
            case 66: // B
                piece = _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.bishop(_Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getColor(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(this.selectedPiece));
                break;
            case 78: // N
                piece = _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.knight(_Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getColor(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(this.selectedPiece));
                break;
            case 82: // R
                piece = _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.rook(_Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getColor(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(this.selectedPiece));
                break;
            case 81: // Q
                piece = _Pieces_bs_js__WEBPACK_IMPORTED_MODULE_2__.queen(_Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getColor(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(this.selectedPiece), _Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(this.selectedPiece));
                break;
        }
        if (piece === undefined) {
            this.failureSound();
    ...
    draw() {
        var grid = _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.makeGrid(this.board, this.turn, this.cursorPosition, this.selectedPiece, this.legalMoves);
        this.drawGrid(grid);
    }
    ...
    drawGrid(data) {
        ...
        // draw base square
        grid.select(".base")
            .attr("width", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.size)
            .attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.size)
            .attr("transform", d => `translate(${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getX(d)} ${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getY(d)})`)
            .attr("fill", d => _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getInCheck(d) ? "red" : _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getColor(d));
        ...
        grid.select(".overlay")
            ...
            .attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.size)
            .attr("transform", d => `translate(${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getX(d)} ${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getY(d)})`)
            .attr("fill", d => _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getOverlayColor(d))
            .style("opacity", 0.8)
            .style("display", d => _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getOverlayColor(d) === "none" ? "none" : "inline");
        ...
        grid.select("image")
            ...
            .attr("width", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.size)
            .attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.size)
            .attr("id", d => _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.positionToId(d.x, d.y))
            .attr("xlink:href", d => (d.piece === undefined) ? "" : `./${_Utils_bs_js__WEBPACK_IMPORTED_MODULE_0__.getAsset(d.piece)}.gif`)
            .style("display", d => (d.piece === undefined) ? "none" : "inline");

        // selection box
        grid.select(".selection")
            .attr("width", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.size - _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.stroke)
            .attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.size - _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.stroke)
            .attr("transform", d => `translate(${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getX(d) + _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.stroke/2} ${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.getY(d) + _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.stroke/2})`)
            .attr("fill", "none")
            .attr("stroke-width", `${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.stroke}px`)
...
window.onload = () => {
    svg = d3.select("#board").append("svg").attr("width", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.size * 8).attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_3__.size * 8);
    var game = new Game();
    game.init();
}
})();
