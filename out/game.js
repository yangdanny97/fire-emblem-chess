...
var Belt_List = __webpack_require__(7);
var Belt_Array = __webpack_require__(8);
...
var Curry = __webpack_require__(5);
var Belt_Array = __webpack_require__(8);
var Caml_option = __webpack_require__(12);
var Belt_SortArray = __webpack_require__(13);
...
var Caml = __webpack_require__(9);
var Curry = __webpack_require__(5);
var Js_math = __webpack_require__(10);
var Caml_option = __webpack_require__(12);
...
var Js_int = __webpack_require__(11);
...
/* harmony export */ });
/* harmony import */ var _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _Utils_bs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _GameState_bs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16);
...
function endTurn() {
    setTimeout(() => {
        state.lock = false;
        state.turn = _Utils_bs_js__WEBPACK_IMPORTED_MODULE_1__.oppositeColor(state.turn);
        state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_2__.handleTurnStart(state);
    }, 1000);
}
...
function drawGrid(data) {
    ...
    // draw base square
    grid.select(".base")
        .attr("width", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.size)
        .attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.size)
        .attr("transform", d => `translate(${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(d)} ${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(d)})`)
        .attr("fill", d => _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getInCheck(d) ? "red" : _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getColor(d));
    ...
    grid.select(".overlay")
        ...
        .attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.size)
        .attr("transform", d => `translate(${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(d)} ${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(d)})`)
        .attr("fill", d => _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getOverlayColor(d))
        .style("opacity", 0.8)
        .style("display", d => _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getOverlayColor(d) === "none" ? "none" : "inline");
    ...
    grid.select("image")
        ...
        .attr("width", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.size)
        .attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.size)
        .attr("id", d => _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.positionToId(d.x, d.y))
        .attr("xlink:href", d => (d.piece === undefined) ? "" : `./${_Utils_bs_js__WEBPACK_IMPORTED_MODULE_1__.getAsset(d.piece)}.gif`)
        .style("display", d => (d.piece === undefined) ? "none" : "inline");

    // selection box
    grid.select(".selection")
        .attr("width", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.size - _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.stroke)
        .attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.size - _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.stroke)
        .attr("transform", d => `translate(${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getX(d) + _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.stroke/2} ${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.getY(d) + _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.stroke/2})`)
        .attr("fill", "none")
        .attr("stroke-width", `${_Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.stroke}px`)
...
var Utils = __webpack_require__(2);
var Pieces = __webpack_require__(3);
var Sounds = __webpack_require__(14);
var Belt_List = __webpack_require__(7);
var GameUtils = __webpack_require__(15);
var Belt_Option = __webpack_require__(17);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _Sounds_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
/* harmony import */ var _GameUtils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
/* harmony import */ var _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16);
...
function setup() {
    ...
    body.on("keydown", () => {
        ...
        switch (key) {
            case 38:
            case 87: // W
                state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.handleUp(state);
                break;
            case 37:
            case 65: // A
                state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.handleLeft(state);
                break;
            case 40:
            case 83: // S
                state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.handleDown(state);
                break;
            case 39:
            case 68: // D
                state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.handleRight(state);
                break;
            case 88: // X
                state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.handleSelect(state);
                break;
            case 90: // Z
                state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.handleCancel(state);
                break;
            case 66: // B
            case 78: // N
            case 82: // R
            case 81: // Q
                state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.handlePromote(state, key);
                break;
        }
    });
    state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.handleTurnStart(state);
    _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.draw(state);
}

window.onload = () => {
    state = _GameState_bs_js__WEBPACK_IMPORTED_MODULE_3__.init();
    svg = d3.select("#board").append("svg").attr("width", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.size * 8).attr("height", _Grid_bs_js__WEBPACK_IMPORTED_MODULE_0__.size * 8);
    setup();
}
})();
